...
public class frmGrafos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Cantidad Caminos");
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(tpeso, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnCargarGrafoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarGrafoActionPerformed
        ...
        G1.insertarArco("A", "C", 1);
        G1.insertarArco("B", "C", 1);
        G1.insertarArco("C", "D", 1);
        G1.insertarArco("C", "E", 1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int cantidad = G1.cantidadCaminos(t1.getText(), t2.getText());
        t3.setText(Integer.toString(cantidad));
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:

        G1.insertarArco(t1.getText(), t2.getText(), Float.parseFloat(tpeso.getText()));
